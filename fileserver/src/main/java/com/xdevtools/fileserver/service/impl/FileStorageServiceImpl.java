package com.xdevtools.fileserver.service.impl;
...
import com.xdevtools.fileserver.service.FileStorageService;
...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    @Override
    public List<String> listFiles() throws MyFileNotFoundException {
        try {
            return Files.list(this.fileStorageLocation)
                    .map(v -> v.toFile().getName()).collect(Collectors.toList());
        } catch (IOException ex) {
